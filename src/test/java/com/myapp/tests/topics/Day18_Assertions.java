...
public class Day18_Assertions {
    ...
    public void hardAssertion(){
        ...
        System.out.println("Line 17 codes");//WILL BOW EXECUTE
    ...
    public void softAssertions(){
        ...
        softAssert.assertAll("TEST CASE COMPLETED"); //assertAll MUST BE USED AT THE END TO MARK THE TEST CASE AS FAIL. THIS MUST
...
assert 5<4;// if the statement is TRUE THEN CONTINUE. if the statement is FALSE THEN THROW java.lang.AssertionError assert "apple".contains ("a");
